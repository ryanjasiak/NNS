...
LegacyNNS.part(x, y, Voronoi = TRUE, order = 3)
...
LegacyNNS.part(x, y, Voronoi = TRUE, order = 3, obs.req = 0)
...
## ----asym1--------------------------------------------------------------------
cor(x, y)
LegacyNNS.dep(x, y, asym = TRUE)

## ----asym2--------------------------------------------------------------------
cor(y, x)
LegacyNNS.dep(y, x, asym = TRUE)
...
LegacyNNS.part(df$x, df$y, Voronoi = TRUE, order = 3, obs.req = 0)

## ----res3---------------------------------------------------------------------
LegacyNNS.dep(df$x, df$y)

## ----permutations-------------------------------------------------------------
## p-values for [LegacyNNS.dep]
set.seed(123)
...
LegacyNNS.dep(x, y, p.value = TRUE, print.map = TRUE)

## ----multi, warning=FALSE-----------------------------------------------------
set.seed(123)
x <- rnorm(1000); y <- rnorm(1000); z <- rnorm(1000)
LegacyNNS.copula(cbind(x, y, z), plot = TRUE, independence.overlay = TRUE)
