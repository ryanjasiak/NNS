...
LPM <- function(degree, target, variable) {
    .Call(`_LegacyNNS_LPM_RCPP`, degree, target, variable)
}
...
UPM <- function(degree, target, variable) {
    .Call(`_LegacyNNS_UPM_RCPP`, degree, target, variable)
}
...
LPM.ratio <- function(degree, target, variable) {
    .Call(`_LegacyNNS_LPM_ratio_RCPP`, degree, target, variable)
}
...
UPM.ratio <- function(degree, target, variable) {
    .Call(`_LegacyNNS_UPM_ratio_RCPP`, degree, target, variable)
}
...
Co.LPM <- function(degree_lpm, x, y, target_x, target_y) {
    .Call(`_LegacyNNS_CoLPM_RCPP`, degree_lpm, x, y, target_x, target_y)
}
...
Co.UPM <- function(degree_upm, x, y, target_x, target_y) {
    .Call(`_LegacyNNS_CoUPM_RCPP`, degree_upm, x, y, target_x, target_y)
}
...
D.LPM <- function(degree_lpm, degree_upm, x, y, target_x, target_y) {
    .Call(`_LegacyNNS_DLPM_RCPP`, degree_lpm, degree_upm, x, y, target_x, target_y)
}
...
D.UPM <- function(degree_lpm, degree_upm, x, y, target_x, target_y) {
    .Call(`_LegacyNNS_DUPM_RCPP`, degree_lpm, degree_upm, x, y, target_x, target_y)
}
...
PM.matrix <- function(LPM_degree, UPM_degree, target, variable, pop_adj) {
    .Call(`_LegacyNNS_PMMatrix_RCPP`, LPM_degree, UPM_degree, target, variable, pop_adj)
}

LegacyNNS_bin <- function(x, width, origin = 0, missinglast = FALSE) {
    .Call(`_LegacyNNS_LegacyNNS_bin`, x, width, origin, missinglast)
}
